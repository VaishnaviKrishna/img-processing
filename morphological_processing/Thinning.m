...
%M-file name: Thinning.m
%Output image: G_thin_pattern
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Shrink_Thin_Skeletonize_4_NE_N_SW=[0 1 1 1 0 0 0 0];
...
if (temp_extended(i,j)==1)
            switch pixel_bond
              ...
              case 4
                if(Shrink_Thin_Skeletonize_4_E_NE_SE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_4_NE_N_SW==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_4_NW_W_SW==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_4_SW_S_SE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Thin_Skeletonize_4_E_N==neighbourhood_1D)
                 M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Thin_Skeletonize_4_N_W==neighbourhood_1D)
                  M(i-(N-1)/2,j-(N-1)/2)=1;
                 elseif(Thin_Skeletonize_4_W_S==neighbourhood_1D)
                 M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Thin_Skeletonize_4_S_E==neighbourhood_1D)
                  M(i-(N-1)/2,j-(N-1)/2)=1;
                end  
                  
                case 5
                if(Shrink_Thin_5_E_N_NW==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_5_E_N_SE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_5_NE_N_W==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_5_E_NE_S==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_5_E_NE_N==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_5_N_NW_W==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_5_W_SW_S==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_5_S_SE_E==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                end
                
                case 6
                
                if(Shrink_Thin_6_E_N_NW_SE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_6_NE_N_W_SW==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_6_E_NE_N_NW==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_6_E_NE_N_SW==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_6_NE_N_NW_W==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_6_N_NW_W_SW==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_6_NW_W_SW_S==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_6_W_SW_S_SE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_6_SW_S_SE_E==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_6_S_SE_E_NE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                end
                
                case 7
                if(Shrink_Thin_Skeletonize_7_E_NE_N_NW_SE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_7_NE_N_NW_W_SW==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_7_NW_W_SW_S_SE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_7_SW_S_SE_E_NE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                end
                
                case 8
                if(Shrink_Thin_Skeletonize_8_E_NE_N_S_SE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_8_E_NE_N_NW_W==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_8_N_NW_W_SW_S==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_8_W_SW_S_SE_E==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                end
                
                case 9
                if(Shrink_Thin_Skeletonize_9_E_NE_N_NW_S_SE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_9_E_NE_N_SW_S_SE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_9_E_NE_N_NW_W_SW==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_9_E_NE_N_NW_W_SE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_9_NE_N_NW_W_SW_S==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_9_N_NW_W_SW_S_SE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_9_NW_W_SW_S_SE_E==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_9_W_SW_S_SE_E_NE==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                end
                
                case 10
                
                if(Shrink_Thin_Skeletonize_10_not_W==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_10_not_S==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_10_not_E==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                elseif(Shrink_Thin_Skeletonize_10_not_N==neighbourhood_1D)
                M(i-(N-1)/2,j-(N-1)/2)=1;
                end
            end
    end
...
for i=1:375
    for j=1:375
        G_thin_pattern(i,j)=temp(i,j) & (~M(i,j) | P(i,j));
    end
end

if(temp==G_thin_pattern)
    flag=0;
else 
    flag=1;
end
...
figure(2);
imshow(uint8(G_thin_pattern.*255));
title('Image obtained after Thinning');